...
Button.propTypes = {
  ...
  buttonStyle: _propTypes2.default.oneOf(['isOutlined', 'isInverted']),
  state: _propTypes2.default.oneOf(['isLoading', 'isActive', 'isDisabled']),
  delete: _propTypes2.default.bool,
  isIconRight: _propTypes2.default.bool,
  data: _propTypes2.default.array,
  safeHtml: _propTypes2.default.string
};
Button.defaultProps = {
  style: {},
  className: ''
